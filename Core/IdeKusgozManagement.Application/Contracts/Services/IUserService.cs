...
namespace IdeKusgozManagement.Application.Interfaces.Services
{
    public interface IUserService
    {
        ...
        Task<ApiResponse<IEnumerable<UserDTO>>> GetUsersByDepartmentAsync(string departmentId, CancellationToken cancellationToken = default);
        ...
        Task<ApiResponse<AnnualLeaveBalanceDTO>> GetAnnualLeaveDaysByUserAsync(string userId, CancellationToken cancellationToken = default);
    }
}