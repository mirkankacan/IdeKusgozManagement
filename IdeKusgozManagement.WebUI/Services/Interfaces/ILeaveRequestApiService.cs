...
namespace IdeKusgozManagement.WebUI.Services.Interfaces
{
    public interface ILeaveRequestApiService
    {
        ...
        Task<ApiResponse<IEnumerable<LeaveRequestViewModel>>> GetLeaveRequestByStatusAsync(int status, CancellationToken cancellationToken = default);
        ...
        Task<ApiResponse<string>> CreateLeaveRequestAsync(CreateLeaveRequestViewModel model, CancellationToken cancellationToken = default);
