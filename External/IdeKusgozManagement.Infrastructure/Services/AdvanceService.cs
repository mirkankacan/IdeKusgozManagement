            ...
            try
            {
                ...
                switch (userRole)
                {
                    ...
                    case "Yönetici":
                        ...
                        {
                            return ServiceResponse<bool>.Error("Avans isteği zaten birim yönetici tarafından onaylanmış");
                        }
                        advance.Status = AdvanceStatus.ApprovedByUnitManager;
                        advance.ProcessedByUnitManagerId = userId;
                        advance.UnitManagerProcessedDate = DateTime.Now;
            ...
            try
            {
                ...
                switch (userRole)
                {
                    ...
                    case "Yönetici":
                        ...
                        {
                            return ServiceResponse<bool>.Error("Avans isteği zaten birim yönetici tarafından reddedilmiş");
                        }
                        advance.Status = AdvanceStatus.RejectedByUnitManager;
                        advance.ProcessedByUnitManagerId = userId;
                        advance.UnitManagerProcessedDate = DateTime.Now;
